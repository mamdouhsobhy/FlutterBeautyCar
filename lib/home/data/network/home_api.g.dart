...
class _HomeServiceClient implements HomeServiceClient {
  ...
  Future<ModelGetNotificationResponseRemote> getNotificationForEmployee(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ModelGetNotificationResponseRemote _value;
    try {
      _value = ModelGetNotificationResponseRemote.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<BaseResponse> readNotify() async {
    ...
    final _options = _setStreamType<BaseResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'vendor/notifications/updateRead',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  @override
  Future<BaseResponse> readNotifyForEmployee() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<BaseResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'employee/notifications/updateRead',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
